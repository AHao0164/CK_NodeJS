			...
			<div className="mx-auto w-full max-w-md">
				...
				<form onSubmit={onSubmit} className="card space-y-4 p-6">
					...
					<div className="flex items-center justify-between text-sm">
						<p className="text-slate-600">No account? <Link to="/signup" className="text-brand-700 hover:text-brand-800">Create one</Link></p>
					...
					<button 
						...
						className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 rounded-xl hover:bg-slate-50 transition-colors"
					>
					...
					<button 
						...
						className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-[#1877f2] hover:bg-[#166fe5] rounded-xl transition-colors"
					>
						<svg className="h-5 w-5" viewBox="0 0 24 24" fill="white">
							<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
						</svg>
						<span className="text-sm font-medium text-white">Sign in with Facebook</span>
					</button>
				</form>
			</div>
		</main>
