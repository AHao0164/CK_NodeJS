  ...
  return (
    <>
      ...
      >
        ...
        {/* Search Bar */}
        <div
          className={`absolute inset-0 z-[3] bg-primary transition-all duration-150 ease-in-out ${
            isSearchOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'
          }`}
        >
          <form onSubmit={handleSearchSubmit} className="flex items-center gap-4 h-full px-4 w-full">
            <div className="flex-1 relative">
              <input
                type="text"
                placeholder="Tìm kiếm sản phẩm..."
                className="w-full px-4 py-3 text-lg border-2 border-primary rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
            ...
            <button
              type="submit"
              className="px-4 py-3 bg-white/20 text-white font-semibold rounded-lg hover:bg-white/30 transition-colors duration-200 flex items-center gap-2"
            >
              <FaSearch />
              Tìm
            </button>
