  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="absolute inset-0 -z-10 opacity-40" aria-hidden>
        ...
        <div className="absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-primary/60 blur-3xl" />
      </div>
        ...
        <div className="flex flex-col items-start gap-10 md:flex-row md:items-center md:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
              Upgrade Performance. Minimize Experience.
            </h1>
            <p className="mt-3 text-slate-300 sm:text-lg">
              Gaming gear for gamers, creators, and professionals. Fast shipping, 0% installment, official warranty.
            </p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a href="#featured"><Button className="px-5 py-2.5">Explore Now</Button></a>
              <a href="#deals"><Button variant="outline" className="px-5 py-2.5 text-white border-white/30 hover:bg-white/10">Deals</Button></a>
            </div>
          </div>
