                    ...
                    >
                        <div>
                            <div className='mb-3 sm:mb-4'>
                                ...
                                <p className='text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal opacity-20 mb-2 font-bitcount'>Earbuds</p>
                            </div>
                        </div>
                    </div>
                </TiltEffect>
                    ...
                    >
                        <div>
                            <div className='mb-3 sm:mb-4'>
                                ...
                                <p className='text-lg sm:text-xl lg:text-2xl font-semibold mb-[2px]'>With</p>
                                <p className='text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal opacity-20 mb-2 font-bitcount'>Speakers</p>
                            </div>
                        </div>
                    </div>
                </TiltEffect>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mt-4 sm:mt-6 lg:mt-8'>
                ...
                >
                    <div 
                        ...
                        onClick={() => handleCategoryClick('gaming pc')}
                    >
                        <div>
                            <div className='mb-3 sm:mb-4'>
                                ...
                                <p className='text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal opacity-20 mb-2 font-bitcount'>PC</p>
                            </div>
                        </div>
                    </div>
                </TiltEffect>
                ...
                >
                    <div 
                        ...
                        onClick={() => handleCategoryClick('gaming mouse')}
                    >
                        <div>
                            <div className='mb-3 sm:mb-4'>
                                <p className='mb-[2px] text-white/60 text-sm sm:text-base'>Enjoy</p>
