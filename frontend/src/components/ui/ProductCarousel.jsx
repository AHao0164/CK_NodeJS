...
export default function ProductCarousel({ products = [], onAdd, title = 'Products', showViewAll = false, viewAllLink = '/products' }) {
  ...
  if (products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="mt-1 text-sm text-slate-500">Check back later for new products</p>
      </div>
    )
  }
