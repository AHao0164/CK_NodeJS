                ...
                {items.map((item, index) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-primary/10 hover:text-primary dark:hover:text-primary transition-all duration-200 text-left group"
                    >
                    ...
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-500">
                          Hover over categories on the left to see details
                        </p>
                      </div>
                    </div>
                  )}
