# Payment Service - Standalone Database Setup (PowerShell)
# Usage: .\init-db.ps1
...
Write-Host "🔧 Initializing Payment Service Database..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "✅ Payment Service database initialized successfully!" -ForegroundColor Green
} else {
