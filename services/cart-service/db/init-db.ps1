# Cart Service - Standalone Database Setup (PowerShell)
# Usage: .\init-db.ps1
...
Write-Host "🔧 Initializing Cart Service Database..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "✅ Cart Service database initialized successfully!" -ForegroundColor Green
} else {
