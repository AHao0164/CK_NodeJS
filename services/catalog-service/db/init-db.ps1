# Catalog Service - Standalone Database Setup (PowerShell)
# Usage: .\init-db.ps1
...
Write-Host "🔧 Initializing Catalog Service Database..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "✅ Catalog Service database initialized successfully!" -ForegroundColor Green
} else {
